...
export default function CliPortfolio() {
  ...
  const downloadCV = () => {
    ...
    link.href = "/Imasha_Jayarathne_CV.pdf" // This will look for cv.pdf in the public folder
    link.download = "Imasha_Jayarathne_Resume.pdf" // Optional: specify download filename
